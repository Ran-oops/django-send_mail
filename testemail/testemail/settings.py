...
SECRET_KEY = 'zf6de&w0h)$-m0q4z8n1lgkved2)^qru5*n0fynxedpn81@c+b'
...
EMAIL_HOST_USER = '936233993@qq.com'   # 发件人
EMAIL_HOST_PASSWORD = 'vnpqynndqachbcfd'   # 密码(这里使用的是授权码)
EMAIL_FROM = 'May<may天快乐@qq.com>'   # 邮件显示的发件人
